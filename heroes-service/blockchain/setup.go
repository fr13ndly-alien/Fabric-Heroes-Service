...
func (setup *FabricSetup) Initialize() error {
	...
	// Channel management client is responsible for managing channels (create/update ``upply user that has privileges to create channel (in this case orderer admin)
